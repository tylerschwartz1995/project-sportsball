-- Run as the Neon database owner AFTER restore/migrations, in database sportsball.
...
-- Set on the server: transaction poolers need not accept startup/session settings.
ALTER ROLE sportsball_web SET statement_timeout = '10s';
REVOKE ALL ON DATABASE :"DBNAME" FROM PUBLIC;
REVOKE CREATE ON SCHEMA public FROM PUBLIC;
GRANT CONNECT ON DATABASE :"DBNAME" TO sportsball_ingestion, sportsball_web, sportsball_backup;
