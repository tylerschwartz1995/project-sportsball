...
| 6. Tables are difficult to scan and decode | Tighter standings columns, grouped team analytics headers, stable Essential/All column control, selected-sort accent, and touch-accessible metric explanations. | Both-theme table walkthrough; column toggles, metric help, and table sizing checks. |
