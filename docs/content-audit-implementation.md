...
| Standings | Keep PTS and W–L–OT in the core table. RW, goals and differential are expanded columns. Hide irrelevant grouping controls in Points Progression. Consolidate snapshot/source/clinch notes once. |
