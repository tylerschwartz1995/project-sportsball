...
| Homepage | Results, upcoming games and standings remain. The player overview combines five-row scoring, season Game Score and GSAx leaderboards with workload and supporting metrics. Advanced rows retain explicit player-team scope. Remove Recent Form, League Trends and duplicate destination promotions, including their extra data queries. Label regular-season lists and upcoming season context; remove the unconditional final-snapshot claim. |
